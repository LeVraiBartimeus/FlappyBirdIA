...
# bird imgs load and scale two times bigger
...
# Pipe img load and scale two times bigger
PIPE_IMG = [pygame.transform.scale2x(
    pygame.image.load(os.path.join("imgs", "pipe.png")))]

# Floor img load and scale two times bigger
BASE_IMG = [pygame.transform.scale2x(
    pygame.image.load(os.path.join("imgs", "base.png")))]

# Background img load and scale two times bigger
